                    ...
                    <div
                        ...
                        <ul className="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
                            <li className="items-center">
                                <NavLink
                                    ...
                                    href="/auth/login"><i className="fas fa-fingerprint text-blueGray-400 mr-2 text-sm"></i>{' '}
                            ...
                            <li className="items-center">
                                <NavLink
                                    className="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                                    href="/auth/register"><i className="fas fa-clipboard-list text-blueGray-300 mr-2 text-sm"></i>{' '}
                        ...
                        <ul className="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
                            ...
                            <li className="items-center">
                                <NavLink
                                    className="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                                    href="/profile"><i className="fas fa-user-circle text-blueGray-400 mr-2 text-sm"></i>{' '}
                                    Profile Page
